...
import { FolderIndicators, ViewRow } from "@/components/app-shell/shell-bits"
...
/** The Forms library sidebar — mirrors FoldersPanel but scoped to forms and
 *  navigating to /forms. Forms have their own folder namespace (kind=FORM),
 *  independent of Guides; the default folder is not renameable/deletable here. */
export function FormsPanel() {
  ...
  function go(v: LibraryView) {
    setView(v)
    if (pathname !== "/forms") router.push("/forms")
  }
  ...
  return (
    <aside className="mt-1.5 mb-1.5 flex w-64 flex-none flex-col overflow-hidden rounded-l-3xl border-t border-r border-b border-l border-[var(--l-hairline)] bg-gradient-to-b from-[var(--l-panel-a)] to-[var(--l-panel-b)]">
      <div className="flex h-14 items-center justify-between border-b px-4">
        <h2 className="text-[15px] font-semibold tracking-tight">Forms</h2>
        <button
