...
import { staggerContainer, staggerItem } from "@/components/datum/motion"
      ...
      <section className="mt-14">
        ...
        {guides && guides.length === 0 && inFlight.length === 0 && (
          <EmptyState
            ...
            description="Your first guide starts with a capture. Record a workflow once — Tacto threads your clicks into a guide you just clean up."
